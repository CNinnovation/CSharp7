...
namespace CSharp7Samples
{
    class Program
    {
        ...
        private static async void ValueTaskSampleAsync()
        {
            int result = await SampleMethodAsync();
            Console.WriteLine($"result:  {result}");
            int result2 = await ReturnsTaskInValueTaskAsync();
            Console.WriteLine(result2);
        }

        public static ValueTask<int> SampleMethodAsync()
        {
            return new ValueTask<int>(3);
        }

        public static ValueTask<int> ReturnsTaskInValueTaskAsync()
        {
            ...
            task1.Start();
            return new ValueTask<int>(task1);
        }
